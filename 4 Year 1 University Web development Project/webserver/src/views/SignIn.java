...
public class SignIn extends DynamicWebPage
{
	...
	{
		if(toProcess.path.equalsIgnoreCase("SignIn.html"))
		{
			...
			stringToSendToWebBrowser += "  <title>Sign In</title>\n";
			...
			stringToSendToWebBrowser += "        <div class=\"col-md-3\"> </div>\n";
			...
			stringToSendToWebBrowser += "              <h1 class=\"mb-4\">Login form</h1>\n";
			stringToSendToWebBrowser += "              <form action=\"https://formspree.io/YOUREMAILHERE\">\n";
			stringToSendToWebBrowser += "                <div class=\"form-group\"> <label>Email address</label>\n";
			stringToSendToWebBrowser += "                  <input type=\"email\" class=\"form-control\" placeholder=\"Enter email\"> </div>\n";
			stringToSendToWebBrowser += "                <div class=\"form-group\"> <label>Password</label>\n";
			stringToSendToWebBrowser += "                  <input type=\"password\" class=\"form-control\" placeholder=\"Password\"> </div>\n";
			stringToSendToWebBrowser += "                <button type=\"submit\" class=\"btn btn-secondary\">Login</button>\n";
			stringToSendToWebBrowser += "              </form>\n";
			stringToSendToWebBrowser += "            </div>\n";
			stringToSendToWebBrowser += "          </div>\n";
			stringToSendToWebBrowser += "          <p class=\"text-primary\">Dont have an account? Click here to Register</p>\n";
			stringToSendToWebBrowser += "        </div>\n";
			stringToSendToWebBrowser += "      </div>\n";
			stringToSendToWebBrowser += "    </div>\n";
			stringToSendToWebBrowser += "  </div>\n";
			...
			stringToSendToWebBrowser += "          <h3 class=\"mb-4\">Pingendo</h3>\n";
