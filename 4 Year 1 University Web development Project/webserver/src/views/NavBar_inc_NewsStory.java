...
public class NavBar_inc_NewsStory extends DynamicWebPage
{

	public NavBar_inc_NewsStory(DatabaseInterface db,FileStoreInterface fs)
	{
		super(db,fs);
	}
	...
	{
		if(toProcess.path.equalsIgnoreCase("NavBar_inc_NewsStory.html"))
		{
