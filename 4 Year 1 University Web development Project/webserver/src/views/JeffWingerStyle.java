...
public class JeffWingerStyle extends DynamicWebPage
{
	public JeffWingerStyle(DatabaseInterface db,FileStoreInterface fs)
	{
		super(db,fs);
	}
	...
	{
		if(toProcess.path.equalsIgnoreCase("JeffWingerStyle.html"))
		{
			OutfitBreakdown outfit = new OutfitBreakdown();
			outfit.mainTitle = "Jeff Winger Style";
			outfit.mainDesc = "You can achieve this slick look rocked by Jeff Winger from the tv series, \"Community\" by purchasing the items below!";
			outfit.mainIMG = "http://images5.fanpop.com/image/photos/31300000/Jeff-jeff-winger-31304349-500-500.gif";
			outfit.sec1Desc = "Made from soft cotton/wool blend. Crew neck and ribbed cuffs.";
			outfit.sec1Title = "Winger Jumper";
			outfit.sec1IMG = "WingerJumper.png";
			outfit.sec1URL = "https://www.amazon.co.uk/Fj%C3%A4llr%C3%A4ven-%C3%96vik-Sweater-Men/dp/B00TLP4CX6/ref=cts_sp_1_vtp";
			outfit.sec2Desc = "A plain white t-shirt to go along with the jumper.";
			outfit.sec2Title = "White T-Shirt";
			...
			stringToSendToWebBrowser += "  <title>Jeff Winger Style Look</title>\n";
			...
			stringToSendToWebBrowser += "        <form action=\"/JeffWingerStyle.html/submit/comment\"> Username:\n";
			...
			MVMap<String, Comment> newComment = db.s.openMap("WingerComments");
		...
		else if(toProcess.path.equalsIgnoreCase("JeffWingerStyle.html/submit/comment"))
		{
			...
			MVMap<String, Comment> commentsMap = db.s.openMap("WingerComments");
			commentsMap.put(newComment.uniqueid, newComment);
			
			db.commit();
			
			String url = "/JeffWingerStyle.html";
