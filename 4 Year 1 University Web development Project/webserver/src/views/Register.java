...
public class Register extends DynamicWebPage
{

	public Register(DatabaseInterface db,FileStoreInterface fs)
	{
		super(db,fs);
	}
	...
	{
		if(toProcess.path.equalsIgnoreCase("Register.html"))
		{
			...
			stringToSendToWebBrowser += "          <h1 class=\"\">Register</h1>\n";
			stringToSendToWebBrowser += "        </div>\n";
			stringToSendToWebBrowser += "      </div>\n";
			stringToSendToWebBrowser += "    </div>\n";
			stringToSendToWebBrowser += "  </div>\n";
			...
			stringToSendToWebBrowser += "              <input type=\"email\" class=\"form-control\" id=\"exampleInputEmail1\" aria-describedby=\"emailHelp\" placeholder=\"Enter email\"> <small id=\"emailHelp\" class=\"form-text text-muted\">We'll never share your email with anyone else.</small> </div>\n";
			stringToSendToWebBrowser += "            <div class=\"form-group\"> <label for=\"exampleInputPassword1\">Username</label>\n";
			stringToSendToWebBrowser += "              <input type=\"text\" class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"e.g. BobJohn1\"> </div>\n";
			stringToSendToWebBrowser += "            <div class=\"form-group\"> <label for=\"exampleInputPassword1\">Password</label>\n";
			stringToSendToWebBrowser += "              <input type=\"password\" class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Password\"> </div>\n";
			stringToSendToWebBrowser += "            <div class=\"form-group\"> <label for=\"exampleInputPassword1\">Confirm Password</label>\n";
			stringToSendToWebBrowser += "              <input type=\"password\" class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Confirm Password\"> </div>\n";
