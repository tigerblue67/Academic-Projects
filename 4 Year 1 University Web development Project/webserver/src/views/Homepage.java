...
stringToSendToWebBrowser += "  <title>FAME</title>\n";
			...
			stringToSendToWebBrowser += "          <li class=\"nav-item\">\n";
			stringToSendToWebBrowser += "            <a class=\"nav-link\" href=\"MakeYourLook.html\">Submit A Look</a>\n";
			stringToSendToWebBrowser += "          </li>\n";
			stringToSendToWebBrowser += "          <li class=\"nav-item\">\n";
			...
			stringToSendToWebBrowser += "          </li>\n";
			stringToSendToWebBrowser += "          <li class=\"nav-item\">\n";
			stringToSendToWebBrowser += "            <a class=\"nav-link text-white\" href=\"SignInSignUp.html\">Sign In/Sign Up</a>\n";
			stringToSendToWebBrowser += "          </li>\n";
			...
			stringToSendToWebBrowser += "          <p class=\"side-comments\"> DO YOU HAVE A STYLE TO SHARE? </p>\n";
			stringToSendToWebBrowser += "        </div>\n";
			stringToSendToWebBrowser += "        <div class=\"col-md-4\">\n";
			stringToSendToWebBrowser += "          <center>\n";
			stringToSendToWebBrowser += "            <a class=\"btn btn-primary btn-style\" href=\"MakeYourLook.html\">Submit A Look!</a>\n";
			stringToSendToWebBrowser += "          </center>\n";
			stringToSendToWebBrowser += "        </div>\n";
			stringToSendToWebBrowser += "        <div class=\"col-md-4\">\n";
			stringToSendToWebBrowser += "          <p class=\"side-comments\"> DON'T HESITATE! JOIN THE COMMUNITY! </p>\n";
			stringToSendToWebBrowser += "        </div>\n";
			stringToSendToWebBrowser += "      </div>\n";
			stringToSendToWebBrowser += "    </div>\n";
			stringToSendToWebBrowser += "  </div>\n";
			...
			stringToSendToWebBrowser += "           <a class=\"Kim Kardashians Makeup\" href=\"KimKardashianInglotMakeup.html\"><img src=\"https://inglot.ie/media/wysiwyg/Kim_K_Bridal_Contour.jpg\" class=\"img-fluid\"></a></div>\n";
			stringToSendToWebBrowser += "        <div class=\"col-md-4 col-6 p-0\">\n";
			stringToSendToWebBrowser += "          <img src=\"https://pingendo.github.io/templates/sections/assets/gallery_bird.jpg\" class=\"img-fluid\"> </div>\n";
			stringToSendToWebBrowser += "        <div class=\"col-md-4 col-6 p-0\">\n";
			stringToSendToWebBrowser += "          <img src=\"https://pingendo.github.io/templates/sections/assets/gallery_farm.jpg\" class=\"img-fluid\"> </div>\n";
			stringToSendToWebBrowser += "        <div class=\"col-md-4 col-6 p-0\">\n";
			stringToSendToWebBrowser += "          <img src=\"https://pingendo.github.io/templates/sections/assets/gallery_girl.jpg\" class=\"img-fluid\"> </div>\n";
			stringToSendToWebBrowser += "        <div class=\"col-md-4 col-6 p-0\">\n";
			stringToSendToWebBrowser += "          <img src=\"https://pingendo.github.io/templates/sections/assets/gallery_nose.jpg\" class=\"img-fluid\"> </div>\n";
			stringToSendToWebBrowser += "        <div class=\"col-md-4 col-6 p-0\">\n";
			stringToSendToWebBrowser += "          <img src=\"https://pingendo.github.io/templates/sections/assets/gallery_feet.jpg\" class=\"img-fluid\"> </div>\n";
			stringToSendToWebBrowser += "      </div>\n";
			stringToSendToWebBrowser += "    </div>\n";
			stringToSendToWebBrowser += "  </div>\n";
