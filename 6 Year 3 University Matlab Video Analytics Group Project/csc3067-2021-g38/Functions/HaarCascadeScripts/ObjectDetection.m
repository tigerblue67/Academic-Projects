...
figure
subplot(1,2,1), imagesc(IntegralImages.ii)
subplot(1,2,2), imagesc(IntegralImages.ii2)
...
%             if j~=k
%                 rect1 = [Objects(j,2),Objects(j,1),FaceSize(2),FaceSize(1)];
%                 rect2 = [Objects(k,2),Objects(k,1),FaceSize(2),FaceSize(1)];
%                 intersection_area = rectint(rect1,rect2);
%                 if (intersection_area/bbArea) > intersectionThreshold
%                     if Objects(j,3)<=Objects(k,3)
%                         badRect = [badRect k];
%                     else
%                         badRect = [badRect j];
%                     end
...
%        Objects(badRect(size(badRect,2)-j+1),:) = []; 
%     end
