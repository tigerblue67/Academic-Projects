...
for i=1:size(Training_Images, 3)
    Training_Images(:, :, i) = medfilt2(Training_Images(:, :, i));
...
%Timing=toc
%saveToText("SVM MED training ", Timing);
...
for i=1:size(Testing_Images, 3)
    Testing_Images(:, :, i) = medfilt2(Testing_Images(:, :, i));
...
%Timing=toc
%saveToText("SVM MED test dataset ", Timing, Accuracy, TP, FP, TN, FN);
...
%Timing=toc;
%saveToText("SVM MED supplied images ", Timing, Accuracy, TP, FP, TN, FN);
