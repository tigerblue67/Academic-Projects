...
modelSVMGabor = SVMtraining(Training_Images, Training_Labels);

Timing=toc
saveToText("SVM Gabor  training ", Timing);

save('./Variables/modelSVMGabor.mat', 'modelSVMGabor');
...
for i=1:size(Testing_Images,1)
    ...
    [prediction, score] = SVMTesting(testnumber, modelSVMGabor);
...
for i=1:7
    ...
    prediction = SVMTesting(testnumber, modelSVMGabor);
...
%Timing=toc;
%saveToText("SVM Gabor supplied images ", Timing, Accuracy, TP, FP, TN, FN);
