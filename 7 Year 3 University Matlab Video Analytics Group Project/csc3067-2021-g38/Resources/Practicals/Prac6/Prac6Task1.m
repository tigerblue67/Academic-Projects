...
subplot(1,3,1), imshow(firstImage), title('Original');
subplot(1,3,2), showHog(hogs(1, :), imageSize), title('The whole hog');
subplot(1,3,3), showHog(weightedAverages, imageSize), title('Support vectors');
