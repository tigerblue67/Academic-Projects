...
public class PlayerSpaceship extends SpaceEntity {
    ...
    public PlayerSpaceship(float startX, float startY, GameScreen gameScreen) {
        ...
        mMovementEmitterLeft = new Emitter(
                particleSystemManager, "txt/particle/PlayerShipThrusterEmitter.JSON",
    ...
    /**
     * Loads the player spaceship asset
     * @param assetManager The games asset manager is passed in
     */
