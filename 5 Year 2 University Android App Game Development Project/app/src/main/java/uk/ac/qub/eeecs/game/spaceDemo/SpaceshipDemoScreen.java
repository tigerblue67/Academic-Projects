...
public class SpaceshipDemoScreen extends GameScreen {
    ...
    private final int NUM_SEEKERS = 10;
    private final int NUM_TURRETS = 5;
    private final int NUM_AVOIDERS = 10;
    /**
    ...
    private void setupSpaceGameObjects() {
        ...
        //Loads the Player spaceship assets
        mPlayerSpaceship.loadAssets(mGame.getAssetManager());
        ...
        Asteroid.loadAssets(mGame.getAssetManager());
        ...
        //Loads the AI Spaceships
        Seeker.loadAssets(mGame.getAssetManager());
