...
public class Supplier {
	...
	public String editSupDetails()
	{
		String supDetails = "";
		supDetails += "----Supplier Details----";
		supDetails += "\nSupplier Code: " + this.supCode + "(this cannot be changed)";
		supDetails += "\n1: Supplier Name: " + this.supName;
		supDetails += "\n2: Supplier Address: " + this.supAddress.getFullAddress();
		supDetails += "\n3: Supplier Region: " + this.supregion.getRegionAsString();
		//supDetails += "\nSupplier Products: \n" + printProductList() + "(this can be changed through edit product menu)";
		supDetails += "\n4: Finish Editing";
		return supDetails;
	}
